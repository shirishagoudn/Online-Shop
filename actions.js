let menElement = document.getElementById("menEle");
let womenElement = document.getElementById("womenEle");
...
function createProductCard(product) {
    ...
    divEle.className = 'div-card';
    card.appendChild(divEle);
    ...
    if (product.compare_at_price) {
        ...
        comparePrice.style.fontSize = "17px";
        comparePrice.style.fontWeight = "bold";
        comparePrice.style.marginLeft = "12px";
        ...
        discountPercent.style.fontSize = "17px";
        discountPercent.style.fontWeight = "bold";
        discountPercent.style.marginLeft = "12px";
        divEle.appendChild(discountPercent);
    }
...
function displayProducts(categoryName) {
    womenElement.style.backgroundColor = "black";
    womenElement.style.color = "white";
    const categoryElement = document.getElementById('productContainer');
    categoryElement.innerHTML = ''; // Clear previous products
    ...
    if (category) {
        ...
        if (categoryName === "men") {
            menElement.style.backgroundColor = "black";
            menElement.style.color = "white";

            womenElement.style.backgroundColor = "#e0e0e0";
            womenElement.style.color = "black";

            kidsElement.style.backgroundColor = "#e0e0e0";
            kidsElement.style.color = "black";
        } else if (categoryName === "women") {
            womenElement.style.backgroundColor = "black";
            womenElement.style.color = "white";

            menElement.style.backgroundColor = "#e0e0e0";
            menElement.style.color = "black";

            kidsElement.style.backgroundColor = "#e0e0e0";
            kidsElement.style.color = "black";
        } else if (categoryName === "kids") {
            kidsElement.style.backgroundColor = "black";
            kidsElement.style.color = "white";
